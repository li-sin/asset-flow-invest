...
const APP_VERSION_NOTE = "美學 Phase 1.5 重做批次1（純顏色版）：漲跌翻台股慣例紅漲綠跌——:root 語意 token --up(紅)/--down(綠)/--flat＋bg，app.js 15 處＋CSS 3 組 class 一次翻齊；排除市場系列色/領先大盤好壞/趨勢線上下。尺度收斂留下一版。基於 v0.38.2";
